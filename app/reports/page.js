      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-400 mt-2">Generate and download warehouse reports</p>
          </div>
          ...
          <div className="flex space-x-1 border-b border-gray-700">
            {reportCategories.map((category, index) => (
              <Button
                key={index}
                variant="ghost"
                className={category.active ? "border-b-2 border-blue-500 text-blue-500" : "text-gray-400"}
              >
                {category.name}
              </Button>
            ))}
          ...
          <CardContent>
            <div className="space-y-4">
              {recentReports.map((report, index) => (
                <div key={index} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-700">
                  ...
                  <Button size="sm" variant="outline" className="bg-gray-700 hover:bg-gray-600 text-white">
